function [max_range_fmcw] = calc_fmcw_max_range_w_snr(rngEq)
%CALC_MAX_RANGE_W_SNR Summary of this function goes here
...
num = (Pt .* Gt * Gr .* Sigma * (Lambda^2)*N*Tr);
den = ((Fc^2)*(4 * pi)^3 * K * T * B * NF * SNRdet);
ratio = num./den;
