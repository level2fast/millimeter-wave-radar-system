...
arguments
    ...
    angResArgs.mimo(1,1){mustBeText} = 0
end
...
if(mimo)
    angular_resolution_deg = (lambda/(distance *num_tx_ant* num_rx_ant *cos(theta)))* (180/pi);
else
    angular_resolution_deg = (lambda/(distance * num_rx_ant *cos(theta)))* (180/pi);
end
