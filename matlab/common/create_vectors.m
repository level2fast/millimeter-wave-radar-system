...
delta_r = physconst('LightSpeed')/(2*radar.Fs); % represents spacing between range vector samples
...
% create our doppler vecto. Doppler vector spacing, always between (-prf/2):(prf/2)
