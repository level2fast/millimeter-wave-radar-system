function [ouput_signal] = cfar_2d_rdm_sim(cfar2dParams)
...
arguments
    ...
    cfar2dParams.NumRangeCells (1,1) = 128
    cfar2dParams.NumDoppCells (1,1) = 256
...
nr = int32(cfar2dParams.NumRangeCells/2);
...
for r = r_min : r_max
    for d = d_min : d_max
		...
		% Loop over each range and doppler training cell with the training 
		% window 
